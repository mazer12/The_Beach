...
ModelClass::ModelClass()
{
	...
	//initRasterizerState(ID3D11Device * device);
...
void ModelClass::initRasterizerState(ID3D11Device* device)
{
	...
	device->CreateRasterizerState(&desc, &m_cull_front_state);

	desc.CullMode = D3D11_CULL_BACK;
	device->CreateRasterizerState(&desc, &m_cull_back_state);
}

void ModelClass::setRasterizerState(ID3D11DeviceContext* m_imm_context, bool cull_front)
{
	if (cull_front) {
